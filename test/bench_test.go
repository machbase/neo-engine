...
//
// go test -benchmem -run=^$ -bench ^BenchmarkAppend$ github.com/machbase/dbms-mach-go/test -benchtime=1m
//
...
// go test -benchmem -run=^$ -bench ^BenchmarkSelect$ github.com/machbase/dbms-mach-go/test -benchtime=1m
//
// 2022.12.13 mac-mini(m1) utm-ubuntu (4 core, 4G mem)
